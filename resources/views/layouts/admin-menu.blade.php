...
<head>
  ...
  <!-- Nucleo Icons -->
  <link href="{{asset('dist/css/dashboard/nucleo-icons.css')}}" rel="stylesheet" />
  <link href="{{asset('dist/css/nucleo-svg.css')}}" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
  <link href="{{ asset('dist/css/dashboard/nucleo-svg.css') }}" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href=" {{asset('dist/css/dashboard/soft-ui-dashboard.css')}}" rel="stylesheet" />
